  ...
  return (
    ...
    <div className="logo  relative mb-7">
      ...
      <form action="" className="flex w-3/4 xl:w-1/2  flex-col items-center gap-6 px-10 md:px-0">
        <h1 className="text-[1.5rem] font-bold md:text-[2rem]">Login in to your account</h1>
        <input className="w-full rounded-lg border-[1px] border-[gray] p-3 outline-none" type="text" placeholder="Username" />
        <input className="w-full rounded-lg border-[1px] border-[gray] p-3 outline-none" type="text" placeholder="Password" />
  
        <button className="w-full rounded-lg bg-indigo-600 p-3 font-medium text-white">Sign In</button>
        <span >Don't have an account? <Link to="/register" className="text-blue-500 underline">Sign Up</Link></span>
      </form>
    </div>
    <div className="right px- hidden flex-1 items-center justify-center bg-[url('https://images.pexels.com/photos/1370295/pexels-photo-1370295.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-cover md:flex">
      <div className="p-5">
        <div className="flex flex-col gap-3 rounded-xl px-3 py-14 leading-10 text-white backdrop-blur-lg">
          ...
          <span className="text-[1.7rem] font-medium tracking-tight">Un buen libro es como un buen amigo, ¡accede a tu cuenta para encontrar a ambos! Sumérgete en un mundo de aventuras literarias con nuestro inicio de sesión</span>
        </div>
      </div>
    </div>
  </div>
